...
import { ArrowRight, Search, ChevronRight, MapPin } from "lucide-react";
...
//   Sprout,
// }
import type { Theme, Region, Insight, Snapshot } from "@/types";
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {themes.map((theme, index) => {
              const Icon = Icons[
                theme.iconName as keyof typeof Icons
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {insights.map((insight, index) => {
              const Icon = Icons[
                insight.iconName as keyof typeof Icons
              ] as React.FC<{ className?: string }>;
